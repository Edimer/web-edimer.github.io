...
- Se pueden definir como una estructura jerárquica que busca particionar el espacio de características e identificar centroides representativos. Desde la parte superior a inferior cada árbol tiene *nodo raíz*, *nodos de decisión o internos* y *nodos hojas o terminales*, los dos primeros  se generan con base en reglas  binarias. En árboles de clasficación es necesario medir la **impureza** de una región específica que contiene datos de diferentes clases, por ejemplo, "bueno" o "malo". 
- **Ventajas:**
