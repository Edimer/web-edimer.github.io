...
modArbol0_prune
```
- **Gráfico de árbol "podado":**

```{r, fig.height=5}
rpart.plot(modArbol0_prune)
```

- **Matriz de confusión árbol "podado":** respecto al árbol sin podar, la diferncia en precisión es muy pequeña (<0.01), sin embargo, la especificidad se aumenta de 0.3444 a 0.4556 con la "poda", aunque la sensitividad haya reducido de 0.8762 a 0.8381.
